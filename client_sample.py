...
response_zh = session.post('http://localhost:8001/transcribe', files=files_zh, data=data_zh)
...
# response_en = session.post('http://localhost:8001/transcribe', files=files_en, data=data_en)
